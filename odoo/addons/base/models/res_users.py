...
class ResUsersApikeys(models.Model):
    ...
    def _check_credentials(self, *, scope, key):
        return _check_apikey_credentials(self.env.cr, scope=scope, key=key, table=SQL.identifier(self._table))
...
def _check_apikey_credentials(cr, *, scope, key, table=SQL.identifier('res_users_apikeys')):
    ...
    ''',
    index=index, scope=scope, table=table))
