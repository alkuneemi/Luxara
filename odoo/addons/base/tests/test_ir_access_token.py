...
class TestIrAccessToken(TransactionCase):
    ...
    def test_grant_access_to_record(self):
        with self.assertRaises(AccessError):  # Sudo environment required to grant access tokens
        ...
        with self.assertRaises(AccessError):  # Sudo environment required to retrieve partner_sudos
    ...
    def test_revoke_access_to_record(self):
        ...
        with self.assertRaises(AccessError):  # Sudo environment required to revoke access tokens
