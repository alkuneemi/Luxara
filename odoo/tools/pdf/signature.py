...
class PdfSigner:
    ...
    * `Digital Signatures in a PDF <https://www.adobe.com/devnet-docs/acrobatetk/tools/DigSig/Acrobat_DigitalSignatures_in_PDF.pdf>`_
    ...
    def sign_pdf(self, sig_overlay_pdf: PdfFileReader = None, field_name: str | None = None) -> bytes | None:
    ...
    def _perform_signature(
        ...
        :type contents_placeholder: _SignatureContentsPlaceholder
        ...
        :type byte_range_placeholder: _ByteRangePlaceholder
