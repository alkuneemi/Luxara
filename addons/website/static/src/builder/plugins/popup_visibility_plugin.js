    ...
    resources = {
        ...
        on_snippet_dropped_handlers: ({ snippetEl }) => {
            ...
            if (modalEl) {
                ...
                this.dependencies.history.addCustomMutation({ apply: hide, revert: reset });
            }
        },
        ...
        on_will_remove_handlers: (el) => {
            if (el.matches(".s_popup")) {
                ...
                this.dependencies.history.applyCustomMutation({ apply: reset, revert: hide });
            }
        },
        scroll_destination_processors: (targetEl) =>
            targetEl.querySelector(".s_popup:scope > .modal"),
