...
export class WebsiteBackgroundOptionPlugin extends Plugin {
    ...
    resources = {
        mark_color_level_selector_params: [
            {
                selector: "section",
                applyTo: ":scope > .carousel:not(.s_carousel_cards, .s_carousel_multiple)",
            },
            {
