...

{
    ...
    'data': [
        ...
        'views/snippets/s_features_bento.xml',
    ...
    'new_page_templates': {
        'about_us': {
            '0': ['s_title_split', 's_parallax', 's_paragraph_bold', 's_numbers_lite', 's_projects_two_columns', 's_manifesto', 's_references_grid', 's_company_team_spotlight', 's_call_to_action'],
            '1': ['s_banner_contained', 's_text_block_split', 's_duo_images', 's_process_steps'],
            '2': ['s_splash_intro', 's_shape_image', 's_features_bento', 's_faq_collapse', 's_cta_centered'],
        },
        'services': {
            ...
            '2': ['s_showcase_square', 's_paragraph_bold', 's_services_grid'],
            '3': ['s_animated_cover', 's_references_lite', 's_projects_two_columns', 's_numbers_lite', 's_quotes_carousel_compact', 's_website_form_bold'],
