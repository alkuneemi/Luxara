...
class Website(models.CachedModel):
    ...
    def _ensure_default_website_consistency(self):
        ...
        if default_website.id != first_website.id:
            ...
            existing_settings = filter(lambda s: s in self._fields, self._get_settings_to_transfer_to_new_default_website())
    ...
    @api.model
    def _get_settings_to_transfer_to_new_default_website(self):
