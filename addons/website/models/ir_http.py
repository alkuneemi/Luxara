...
class IrHttp(models.AbstractModel):
    ...
    def _match(cls, path):
        ...
        # TODO: inline _get_current_website_fallback
    ...
    def _get_current_website_fallback(self):
        ...
        domain_name = (
            ...
            or '')
        return self._get_current_website_id_from_domain(domain_name)

    @api.model
    @tools.ormcache('domain_name')
    def _get_current_website_id_from_domain(self, domain_name):
