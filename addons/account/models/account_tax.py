...
# This sentinel object, when in the context, allow to bypass some tax
# usage consistency checks when creating a new tax
_ACCOUNT_TAX_CREATION = object()
...
class AccountTax(models.Model):
    ...
    def _check_company_consistency(self):
        if self.env.context.get('from_account_tax_creation') is _ACCOUNT_TAX_CREATION:
    ...
    def create(self, vals_list):
        ...
        context.update({
            ...
            'from_account_tax_creation': _ACCOUNT_TAX_CREATION,  # At create, skip some usage consistency checks
        })
