...
class AccountPaymentRegister(models.TransientModel):
    ...
    @api.model
    def _resolve_payment_display_partner(self, lines, fallback_partner_id):
        # Lines have partner_id forced to the commercial partner by
        # account.move._inverse_partner_id, so the display partner
        # (the invoice contact) lives on move_id.partner_id.
    ...
    def _create_payment_vals_from_wizard(self, batch_result):
        payment_vals = {
            ...
            'partner_id': self._resolve_payment_display_partner(self.line_ids, self.partner_id.id),
    ...
    def _create_payment_vals_from_batch(self, batch_result):
        ...
        payment_vals = {
            ...
            'commercial_partner_id': batch_values['partner_id'],
            'partner_id': self._resolve_payment_display_partner(batch_result['lines'], batch_values['partner_id']),
