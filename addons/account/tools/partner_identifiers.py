...
IDENTIFIERS_METADATA = {
    ...
    'SA_AIS': {
        'sequence': 10,
        'label': _lt('Identification Scheme'),
        'category': 'AIS',
        'countries': ['SA'],
        'type': 'selection',
        'choices': [
            {'value': 'TIN', 'label': 'Tax Identification Number'},
            {'value': 'CRN', 'label': 'Commercial Registration Number'},
            {'value': 'MOM', 'label': 'MOMRAH License'},
            {'value': 'MLS', 'label': 'MHRSD License'},
            {'value': '700', 'label': '700 Number'},
            {'value': 'SAG', 'label': 'MISA License'},
            {'value': 'NAT', 'label': 'National ID'},
            {'value': 'GCC', 'label': 'GCC ID'},
            {'value': 'IQA', 'label': 'Iqama Number'},
            {'value': 'PAS', 'label': 'Passport ID'},
            {'value': 'OTH', 'label': 'Other ID'},
        ],
    },
    'SA_AIN': {
        'sequence': 20,
