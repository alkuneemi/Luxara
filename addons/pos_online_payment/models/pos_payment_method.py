...
class PosPaymentMethod(models.Model):
    ...
    online_payment_provider_ids = fields.Many2many('payment.provider', string="Allowed Providers", domain="[('is_published', '=', True), ('module_state', 'in', ['installed', 'uninstallable'])]")
