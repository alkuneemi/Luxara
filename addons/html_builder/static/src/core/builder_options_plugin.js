...
export class BuilderOptionsPlugin extends Plugin {
    ...
    resources = {
        ...
        on_history_commit_undone_handlers: (revertedCommit) =>
            this.restoreContainers(revertedCommit, HISTORY_COMMIT_TYPES.UNDO),
        on_history_commit_redone_handlers: (revertedCommit) =>
            this.restoreContainers(revertedCommit, HISTORY_COMMIT_TYPES.REDO),
