...
export class BackgroundShapeOptionPlugin extends Plugin {
    ...
    syncShapeColorsWithTheme(updatedColorVariable) {
        ...
        const targetedBgShapeEls = [...this.document.querySelectorAll(selector)];
        this.refreshShapeEls(targetedBgShapeEls);
    }
    /**
     ...
     */
    onSnippetAdditionDialog({ snippetModel }) {
        ...
        const targetedBgShapeEls = customSnippets.flatMap((snippet) => [
