declare module "plugins" {
    ...
    import { invisible_items, on_visibility_impacted_droppable_snippets_handlers, VisibilityShared } from "@html_builder/core/visibility_plugin";
    ...
    export interface BuilderResourcesList {
        ...
        on_visibility_impacted_droppable_snippets_handlers: on_visibility_impacted_droppable_snippets_handlers;
