...
class PurchaseOrderLine(models.Model):
    ...
    def _compute_price_unit_and_date_planned_and_name(self):
        for line in self:
            ...
            # When we change tax mode we should reset the taxes to the ones on the product
            if line.price_unit_json and line.price_unit_json['document_tax_mode'] != line.document_tax_mode:
                self._compute_tax_id()
            ...
            if line.price_unit_json and line.product_qty == line.price_unit_json['qty']:
                price_unit = line.price_unit if line.price_unit else price_unit
