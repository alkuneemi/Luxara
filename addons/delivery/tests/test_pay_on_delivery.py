...
class TestPayOnDelivery(CashOnDeliveryCommon):
    ...
    def setUpClass(cls):
        ...
        cls.product_line.qty_delivered_method = "manual"
    ...
    def test_final_action_confirms_payment_on_delivery(self):
        ...
        self.mock_cron_trigger.assert_called_once()
    ...
    def test_amount_on_delivery_equals_zero_if_everything_was_delivered_and_paid_for(self):
        self.product_line.qty_delivered = 5
        self.sale_order._confirm_payment_on_delivery()
    ...
    def test_amount_on_delivery_ignores_downpayment_invoices(self):
        self.product_line.qty_delivered = 5  # Fully delivered
        downpayment_wizard = self.sale_order.env["sale.advance.payment.inv"].create({
        ...
        downpayment_wizard._create_invoices(self.sale_order)  # Already in draft

        self.assertEqual(self.sale_order.amount_on_delivery, 0.8 * self.sale_order.amount_total)
