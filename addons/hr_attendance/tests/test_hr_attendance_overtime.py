...
class TestHrAttendanceOvertime(HttpCase):
    ...
    def test_regenerate_weekly_overtime_flexible_employee(self):
        ...
        attendances = self.env['hr.attendance'].create([
            {
                "employee_id": self.flexible_employee.id,
                "check_in": datetime(2026, 5, 4, 8, 15, 0),
                "check_out": datetime(2026, 5, 4, 18, 15, 0),
            },
            {
                "employee_id": self.flexible_employee.id,
                "check_in": datetime(2026, 5, 5, 8, 15, 0),   # Start at midnight in Brussels
                "check_out": datetime(2026, 5, 5, 18, 15, 0),
            },
            {
                "employee_id": self.flexible_employee.id,
                "check_in": datetime(2026, 5, 6, 8, 15, 0),   # Start at midnight in Brussels
                "check_out": datetime(2026, 5, 6, 18, 15, 0),
            },
            {
                "employee_id": self.flexible_employee.id,
                "check_in": datetime(2026, 5, 7, 8, 15, 0),   # Start at midnight in Brussels
                "check_out": datetime(2026, 5, 7, 18, 15, 0),
            },
            {
                "employee_id": self.flexible_employee.id,
                "check_in": datetime(2026, 5, 8, 8, 15, 0),   # Start at midnight in Brussels
                "check_out": datetime(2026, 5, 8, 18, 15, 0),
            },
        ])
        self.ruleset.action_regenerate_overtimes()
