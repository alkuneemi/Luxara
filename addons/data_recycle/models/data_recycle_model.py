...
class Data_RecycleModel(models.Model):
    ...
    unified_id = fields.Many2one('data_cleaning.unified', string='Unified Model', required=True,
    ...
    res_model_name = fields.Char(related='unified_id.res_model_name', string='Model Name', readonly=True, store=True)
