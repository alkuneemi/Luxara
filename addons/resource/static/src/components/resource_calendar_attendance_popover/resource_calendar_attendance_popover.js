...
export class ResourceCalendarAttendancePopover extends Component {
    ...
    static props = {
        ...
        startDelta: { type: Object, optional: true },
        endDelta: { type: Object, optional: true },
        isAllDay: { type: Boolean, optional: true },
    };
        ...
        return {
            ...
            hooks: {
                onRootLoaded: (root) => {
                    ...
                    if (this.props.delta) {
                        const start = this.props.startOcurrenceDateTime.plus(this.props.delta);
                        if (this.props.isAllDay) {
                            ...
                            const end = this.props.endOcurrenceDateTime.plus(this.props.delta);
                            root.update({
                                date: start,
