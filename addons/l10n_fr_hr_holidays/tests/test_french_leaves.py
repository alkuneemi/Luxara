...
class TestFrenchLeaves(TransactionCase):
    ...
    def test_leave_type_half_day_different_working_hours_with_full_day_period(self):
        ...
        self.assertEqual(test_leave.number_of_days, 1, 'The duration should be 1 day.')

        test_leave.request_date_from_period = 'am'
        test_leave.request_date_to_period = 'am'
        self.assertEqual(test_leave.number_of_days, 0.5, 'The duration should be 0.5 day.')
        ...
        self.assertEqual(last_day_leave.number_of_days, 3, 'The duration should be 3 day.')
