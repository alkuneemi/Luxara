...
test("leave stats render correctly", async () => {
    ...
    expect(queryAll("span:contains(days)", { root: individualLeaves })).toHaveCount(2); // One for approved, one for remaining
    ...
    expect(queryAll("h4:contains(R&D)", { root: DepartmentLeaves })).toHaveCount(1);
