...
class AccountEdiProxyClientUser(models.Model):
    ...
    def _peppol_process_messages_status(self, messages, uuid_to_record):
        self.ensure_one()
        # TODO:
        #   - Maybe account_peppol / account_peppol_response version could be reworked a bit.
        #   - But also if we do not put the XML in the chatter we only have to extend the document_type check
    ...
    def _pdp_send_response(self, reference_moves, status, additional_info=None):
        ...
        # TODO: PDP Lifecycle vs Peppol Response
