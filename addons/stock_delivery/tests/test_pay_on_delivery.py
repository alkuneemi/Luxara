...
class TestPayOnDelivery(CashOnDeliveryCommon):
    ...
    def test_picking_validation_is_resumed_after_payment_confirmation(self):
        ...
        with (
            ...
            pay_on_delivery_wizard.action_confirm_next_payment()
    ...
    def test_no_followup_if_no_remaining_picking(self):
        self.product_move._set_quantity_done(3)  # Out of 5
        ...
        self.assertEqual(self.sale_order.get_portal_last_transaction().state, "done")
        self.assertFalse(self.sale_order.transaction_ids.filtered(lambda tx: tx.state == "pending"))

    def test_followup_if_even_if_no_backorder(self):
        self.product_move._set_quantity_done(3)  # Out of 5
        self.picking.action_split_transfer()
        self.assertEqual(len(self.sale_order.picking_ids), 2)
        # Validate fewer products than the 3 now expected
        self.product_move._set_quantity_done(2)
        ...
        self.assertEqual(self.sale_order.get_portal_last_transaction().state, "pending")
