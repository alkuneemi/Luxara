import { Component, reactive, useEffect, useRef } from "@odoo/owl";
...
export class TourInteractivePointer {
    ...
    pointTo(el, action) {
        ...
        this.overlayProps.width = width;
        this.overlayProps.height = height;
        this.overlayProps.top = top;
        this.overlayProps.left = left;
    ...
    openPopover() {
        ...
        this.removeOverlay = this.env.services.overlay.add(TourPointerOverlay, this.overlayProps);
    }
...
class TourPointerOverlay extends Component {
    ...
    setup() {
        this.tourOverlay = useRef("tourOverlay");
        useEffect(() => {
            if (this.tourOverlay.el) {
                this.tourOverlay.el.style.width = this.props.width + "px";
                this.tourOverlay.el.style.height = this.props.height + "px";
                this.tourOverlay.el.style.top = this.props.top + "px";
                this.tourOverlay.el.style.left = this.props.left + "px";
            }
        });
    }
}
