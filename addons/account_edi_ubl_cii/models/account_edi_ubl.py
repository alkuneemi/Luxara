...
class AccountEdiUBL(models.AbstractModel):
    ...
    def _import_ubl_invoice_line_add_optional_fields(self, collected_values):
        ...
        line_fields = {
            'in_invoice': PEPPOL_INVOICE_OPTIONAL_LINE_FIELDS,
            'in_refund': PEPPOL_CREDIT_NOTE_OPTIONAL_LINE_FIELDS,
    ...
    def _import_ubl_invoice_optional_fields(self, collected_values):
        ...
        invoice_fields = {
            'in_invoice': PEPPOL_INVOICE_OPTIONAL_FIELDS,
            'in_refund': PEPPOL_CREDIT_NOTE_OPTIONAL_FIELDS,
        }.get(invoice.move_type, {})
