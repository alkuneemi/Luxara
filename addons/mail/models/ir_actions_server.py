...
class IrActionsServer(models.Model):
    ...
    def _run_action_next_activity(self, eval_context=None):
        ...
        for record in records:
            ...
            elif self.activity_user_type == 'generic':
                user = record[self.activity_user_field_name] if self.activity_user_field_name in record else \
                    record.mapped(self.activity_user_field_name)
            if user:
