...
from odoo.tools import BinaryBytes, format_list, email_normalize, html_escape, html2plaintext
...
class DiscussChannel(models.Model):
    ...
    def _notify_by_web_push_prepare_payload(self, message, msg_vals=False, force_record_name=False):
        ...
        if self.channel_type == 'chat':
            ...
            body = html2plaintext(msg_vals.get("body", message.body), include_references=False)
