...
registry.category("web_tour.tours").add("mail_poll_tour.js", {
    steps: () => [
        ...
        { trigger: "button:contains('Create Poll')", run: "click" },
        ...
        { trigger: ".o-Emoji:contains('❤️')", run: "click" },
        { trigger: ".o-mail-CreatePollOptionDialog:eq(0):contains('❤️')" },
        ...
        { trigger: ".o-mail-PollOption:contains('❤️ Red') input:not(:checked)" },
        ...
        { trigger: ".o-mail-Poll a:contains('1 vote')", run: "click" },
        { trigger: ".o-mail-PollVotesPanel:contains('❤️ Red (0)')" },
