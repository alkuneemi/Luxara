...
export class CallDebrief extends Component {
    ...
    setup() {
        ...
        useLayoutEffect(
            (playbackRate, volume, isMuted, currentSegment, media) => {
                if (media) {
            ...
            () => [
                ...
                this.state.volume,
                this.state.isMuted,
                this.state.currentSegment, // Re-apply settings when media element is replaced
                this.mediaPlayerRef.el,
            ]
        );
    }
    ...
    setPlaybackTime(options = {}) {
        ...
        // If we fell into a break between recordings, snap to the start of the next segment
