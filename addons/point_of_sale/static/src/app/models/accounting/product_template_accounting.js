...
export class ProductTemplateAccounting extends Base {
    ...
    getTaxDetails(opts = {}) {
        ...
        accountTaxHelpers.add_tax_details_in_base_line(baseLine, this.config.company_id);
        accountTaxHelpers.round_base_lines_tax_details([baseLine], this.config.company_id);
    ...
    get displayPriceUnit() {
        ...
        return formatCurrency(price, this.config.currency_id.id);
    }
}
