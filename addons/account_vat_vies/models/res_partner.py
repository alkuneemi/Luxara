...
class ResPartner(models.Model):
    ...
    def _get_iap_vies_credentials(self):
        ...
        if not self.env.ref('account_vat_vies.vies_iap_check_update', raise_if_not_found=False):
    ...
    def _update_vies_status(self, status):
        ...
        if status == 'pending':
            ...
            msg = self.env._("The Intra-Community validity has been updated.")
        if msg:
