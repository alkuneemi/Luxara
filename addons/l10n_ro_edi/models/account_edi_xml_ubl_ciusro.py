...
class AccountEdiXmlUBLRO(models.AbstractModel):
    ...
    def _add_invoice_config_vals(self, vals):
        ...
        AccountEdiUBLPintRO = self.env['account.edi.ubl_pint_eu_ro']
        if invoice.move_type == 'out_invoice':
            AccountEdiUBLPintRO._define_document_type(vals, 'invoice')
        elif invoice.move_type == 'out_refund':
            AccountEdiUBLPintRO._define_document_type(vals, 'credit_note')
