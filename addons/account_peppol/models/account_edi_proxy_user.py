...
class Account_Edi_Proxy_ClientUser(models.Model):
    ...
    def _cron_peppol_auto_register_services(self):
        # This cron is only useful for the upgrade from saas-19.2 to saas-19.3, as the Application Response
        # handling was added to account_peppol in saas-19.3. We thus need to update the services support for
        # all Peppol users upgrading to saas-19.3
