...
class L10nHuEdiConnection(BaseL10nHuEdiConnection):
    ...
    def query_invoice_digest(self, credentials, datetime_from, datetime_to, page):
        template_values = {
    ...
    def query_invoice_data(self, credentials, digests):
        ...
        for query_invoice_data_params in digests:
            ...
            moves_vals, post_process_data = self.env['account.move']._l10n_hu_edi_parse_query_invoice_data_response(response_xml)
