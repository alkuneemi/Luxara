...
class TestUiFeedback(HttpCaseWithUserDemo):
    ...
    def test_08_survey_roaming_mandatory_questions_with_triggers(self):
        ...
        q1, q2, _ = survey_with_mandatory_questions_with_triggers.question_and_page_ids
        q2.triggering_answer_ids = q1.suggested_answer_ids.filtered(lambda a: a.value == 'Answer 2')
