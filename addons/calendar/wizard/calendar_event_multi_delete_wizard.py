...
class CalendarEventMultiDeleteWizard(models.TransientModel):
    ...
    def _default_delete_wizard_ids(self):
        ...
        return [fields.Command.create({'calendar_event_id': event_id, 'template_id': self.env.context.get('template_id')}) for event_id in event_ids]
    ...
    def action_delete(self):
        self.delete_wizard_ids.calendar_event_id.unlink()
