...
class ProjectTask(models.Model):
    ...
    def _onchange_task_company(self):
        ...
        self.user_ids = self.user_ids.filtered(
            lambda u: not self.company_id or self.company_id in u.company_ids
        )
    ...
    def write(self, vals):
        ...
        if 'company_id' in vals:
            for task in self:
                task.user_ids = task.user_ids.filtered(lambda user: not task.company_id or task.company_id in user.company_ids)
