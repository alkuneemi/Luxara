...
import { useGlobalExternalListener } from "../../utils/hooks";
...
export class TableDragDrop extends Component {
    ...
    setup() {
        ...
        useGlobalExternalListener(this.props.document, "pointermove", this.onPointerMove);
        useGlobalExternalListener(this.props.document, "pointerup", this.onPointerUp);
