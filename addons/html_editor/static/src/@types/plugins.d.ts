declare module "plugins" {
    ...
    import { DomObserverShared, attribute_mutation_to_apply_value_processors, set_attribute_overrides, on_content_updated_handlers, attribute_mutation_value_processors, on_pending_mutations_staged_handlers, serializable_descendants_processors, on_pending_mutations_normalized_handlers, on_will_filter_mutation_record_handlers, is_mutation_savable_predicates, is_classlist_mutation_savable_predicates } from "@html_editor/core/dom_observer_plugin";
    ...
    import { on_committed_to_history_handlers, on_will_reset_history_handlers, HistoryShared, on_history_commit_redone_handlers, on_history_commit_undone_handlers, on_savepoint_restored_handlers, is_commit_reversible_predicates, on_will_rebase_history_handlers, on_history_rebased_handlers, on_remote_history_commit_applied_handlers, on_apply_commit_handlers, on_revert_commit_handlers, on_will_preview_handlers, on_commit_restored_handlers, on_irreversible_commit_applied_handlers, on_will_discard_history_handlers, on_pending_changes_unstashed_handlers, has_commit_changes_predicates, pending_commit_data_processors, snapshot_commit_data_processors, save_point_data_processors, on_history_reset_handlers, on_will_invalidate_pending_changes_handlers } from "@html_editor/core/history_plugin";
    ...
    export interface EditorResourcesList {
        ...
        on_apply_commit_handlers: on_apply_commit_handlers;
        on_component_mounted_handlers: on_component_mounted_handlers;
        on_commit_restored_handlers: on_commit_restored_handlers;
        ...
        on_will_discard_history_handlers: on_will_discard_history_handlers;
        ...
        on_irreversible_commit_applied_handlers: on_irreversible_commit_applied_handlers;
        ...
        on_revert_commit_handlers: on_revert_commit_handlers;
        ...
        has_commit_changes_predicates: has_commit_changes_predicates;
        ...
        attribute_mutation_to_apply_value_processors: attribute_mutation_to_apply_value_processors;
        attribute_mutation_value_processors: attribute_mutation_value_processors;
        ...
        pending_commit_data_processors: pending_commit_data_processors;
        save_point_data_processors: save_point_data_processors;
        serializable_descendants_processors: serializable_descendants_processors;
        snapshot_commit_data_processors: snapshot_commit_data_processors;
