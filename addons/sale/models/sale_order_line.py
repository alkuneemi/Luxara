            ...
            for line in lines.with_company(company):
                ...
                if (
                    ...
                    if not line.price_unit:
                        ...
                        if [tax for tax in line.tax_ids if tax._is_price_included(line.document_tax_mode)] != [tax for tax in result if tax._is_price_included(line.document_tax_mode)]:
                            line.price_unit = line.price_unit_json['price_unit'] = line.product_id._get_tax_included_unit_price_from_price(
                                line.price_unit,
                                line.tax_ids,
                                fiscal_position=line.order_id.fiscal_position_id,
                                product_taxes_after_fp=result,
    ...
    def _compute_price_unit(self):
        for line in self:
            ...
            if not line.product_uom_id or not line.product_id:
                ...
                price = line.price_unit if line.price_unit else line._get_display_price()
