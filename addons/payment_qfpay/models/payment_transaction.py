...
class PaymentTransaction(models.Model):
    ...
    def _qfpay_prepare_payment_intent_payload(self, txamt, return_url):
        ...
        # Only include the merchant ID if it's set on the provider as it is not mandatory
        if self.provider_id.qfpay_mchntid:
            payload["mchid"] = self.provider_id.qfpay_mchntid
