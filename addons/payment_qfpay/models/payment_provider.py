...
class PaymentProvider(models.Model):
    ...
    qfpay_mchntid = fields.Char(string="Merchant ID", copy=False)
    ...
    def _qfpay_get_env_config(self):
        ...
        configs = {
            ...
            "test": {
                "api_url": "https://test-openapi-hk.qfapi.com",
                "sdk_url": "https://test-cdn-hk.qfapi.com/qfpay_element/qfpay.js",
                "sdk_env": "test",
                "sdk_region": "hk",
            },
        }
    ...
    def _build_request_headers(self, method, endpoint, payload, **kwargs):
        ...
        - X-QF-SIGN: SHA256 signature of the request payload
        - X-QF-SIGNTYPE: the signature method, which is always SHA256
        """
        if self.code != "qfpay":
