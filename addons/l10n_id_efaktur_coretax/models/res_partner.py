...
class Partner(models.Model):
    ...
    def _l10n_id_efaktur_tku_branch(self):
        """TKU branch digits for CoreTax e-Faktur (from ``additional_identifiers['TKU']``)."""
        self.ensure_one()
        return (self._get_additional_identifier('TKU') or '').strip() or '000000'
    ...
    def _compute_is_company(self):
        ...
        for partner in l10n_id_partners:
            vat = partner.vat or ''
            tku = (partner._get_additional_identifier('TKU') or '000000').strip()
