    ...
    def create(self, vals_list):
        ...
        for idx, vals in enumerate(vals_list):
            ...
            if vals.get('user_id'):
                ...
                # the thing is to prioritize work email, except if work contact is given and than has an email address.
                ...
                if user and user.employee_id:
                    raise ValidationError(_("An employee already exists for the given work contact id: %s", work_contact_id))
                ...
                if not user and not self.env.context.get('no_employee_user'):
                    ...
                    if work_email and not email_from_contact and not email_normalized:
                        raise ValidationError(_('Invalid e-mail address (%s) for %s', vals.get('work_email'), vals['name']))
