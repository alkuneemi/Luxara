...
class PosPreset(models.Model):
    ...
    def _load_pos_self_data_fields(self, config):
        ...
        params.extend(['service_at', 'mail_template_id', 'free_delivery_min_amount', 'delivery_product_id', 'delivery_product_price', 'service_fee', 'service_fee_product_id', 'service_fee_type', 'service_fee_amount', 'service_fee_based_on'])
        return params
