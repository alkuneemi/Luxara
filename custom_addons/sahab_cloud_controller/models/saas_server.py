# -*- coding: utf-8 -*-
  ...
  class SaasServer(models.Model):
      ...
      _name = 'saas.server'
      _description = 'Sahab Cloud Server Configuration'
      _rec_name = 'name'

      name = fields.Char(
          string='اسم الإعداد',
          required=True,
          default='إعداد Sahab Cloud الرئيسي',
      )
      ...
      github_repo_url = fields.Char(
          string='رابط مستودع Sahab Cloud الأم',
          required=True,
          default='https://github.com/alkuneemi/Sahab Cloud',
      ...
      def _compute_callback_url(self):
          base = self.env['ir.config_parameter'].sudo().get_param(
              'web.base.url', 'https://sahabcloud.app'
          )
          for rec in self:
